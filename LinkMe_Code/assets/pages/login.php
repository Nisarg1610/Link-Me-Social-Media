        ...
        <div class="col-sm-12 col-md-4 bg-white border rounded p-4 shadow-sm">
            <form method="post" action="assets/php/actions.php?login">
                ...
                <div class="mt-3 d-flex justify-content-between align-items-center">
                    <button class="btn btn-primary" type="submit" style="background-color: #ffa857;">Sign in</button>
                    <a href="?signup" class="text-decoration-none" style="color: #ffa857;">Create New Account</a>


                </div>
                <a href="?forgotpassword&newfp" class="text-decoration-none" style="color: #ffa857;">Forgot password ?</a>
            </form>
        </div>
    </div>
